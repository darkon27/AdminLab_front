...
@Component({
    selector: 'ngx-comprobante-particular-buscar',
    templateUrl: './comprobante-particular-buscar.component.html'
  })
export class ComprobanteParticularBuscarComponent extends ComponenteBasePrincipal implements OnInit {
