...
@Component({
    selector: 'ngx-atencion-particulares-buscar',
    templateUrl: './atencion-particulares-buscar.component.html'
  })
export class AtencionParticularesBuscarComponent extends ComponenteBasePrincipal implements OnInit {
