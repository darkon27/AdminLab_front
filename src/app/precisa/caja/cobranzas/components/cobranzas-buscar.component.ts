...
@Component({
    selector: 'ngx-cobranzas-buscar',
    templateUrl: './cobranzas-buscar.component.html'
  })
export class CobranzasBuscarComponent extends ComponenteBasePrincipal implements OnInit {
