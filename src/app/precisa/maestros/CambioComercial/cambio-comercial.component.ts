...
export class CambioComercialComponent extends ComponenteBasePrincipal implements OnInit,UIMantenimientoController {
  ...
  coreNuevo(): void {
    this.cambioComercialMantenimientoComponent.cargarAcciones(new MensajeController(this, 'SELECTOR_PARAMETROS', ''),ConstanteUI.ACCION_SOLICITADA_NUEVO, this.objetoTitulo.menuSeguridad.titulo);
  }
